...
// Form open
echo form_open_multipart(site_url('kendaraan/tambahKendaraan'), ' class="form-horizontal"');
?>

<div class="form-group form-group-lg">
  <label class="col-md-2 control-label">No Plat</label>
  <div class="col-md-5">
    <input type="text" name="noPlat" class="form-control" placeholder="No Plat" value="<?php echo set_value('noPlat') ?>" required>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-5">
    <input type="text" name="merekKendaraan" class="form-control" placeholder="Merek Kendaraan" value="<?php echo set_value('merekKendaraan') ?>" required>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-5">
    <input type="text" name="jenisKendaraan" class="form-control" placeholder="Jenis Kendaraan" value="<?php echo set_value('jenisKendaraan') ?>" required>   
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-5">
    <input type="text" name="warnaKendaraan" class="form-control" placeholder="Warna Kendaraan" value="<?php echo set_value('warnaKendaraan') ?>" required>   
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-5">
    <input type="number" name="biayaStandar" class="form-control" placeholder="Biaya Standar" value="<?php echo set_value('biayaStandar') ?>" required>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-5">
    <input type="number" name="durasi" class="form-control" placeholder="Durasi Tersedia" value="<?php echo set_value('durasi') ?>" required>
  </div>
</div>
