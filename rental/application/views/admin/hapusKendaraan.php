...
// Form open
echo form_open_multipart(site_url('kendaraan/hapusKendaraan/'.$kendaraan['noPlat']), ' class="form-horizontal"');
?>

<div class="form-group">
  <label class="col-md-2 control-label">HAPUS DATA KENDARAAN</label>
  <div class="col-md-5">
    <button class="btn btn-danger btn-lg" name="submit" type="submit">
    	HAPUS
    </button>
    <h4>Anda yakin ingin menghapus data ini? Data yang sudah dihapus tidak dapat dikembalikan!</h4>
  </div>
</div>
